...
def do_request(emergency_passphrase, request, *args, **kwargs):
    r = request(*args, auth=(PASSPHRASE_USERNAME, emergency_passphrase), **kwargs)
    ...
    raise AuthenticationException('Authorization error.\n'
        ...
        'in the ' + EMERGENCY_PASSPHRASE_VARIABLE + ' environment variable')
