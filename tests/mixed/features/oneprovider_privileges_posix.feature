Feature: POSIX privileges acceptance mixed tests
  ...
  Scenario: User creates a file using oneclient and sees its permissions in browser
  ...
  Scenario: User creates a directory using oneclient and sees its permissions in browser
  ...
  Scenario: User creates a file using web gui and sees its permissions using oneclient
  ...
  Scenario: User creates a directory using web gui and sees its permissions using oneclient
