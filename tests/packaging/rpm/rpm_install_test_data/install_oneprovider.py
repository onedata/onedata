...
check_call(['ls', '/opt/onedata/onedata{release}/root/etc/cluster_manager/autogenerated.config'])
check_call(['ls', '/opt/onedata/onedata{release}/root/etc/op_worker/autogenerated.config'])
