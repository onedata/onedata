Feature: Oneprovider Group functionality
  ...
  Background:
    Given user of browser1 opens a Onezone URL in a web browser
...
#    And user clicks on the "groups" tab in main menu sidebar
  ...
  Scenario: heh
    Given other users logged in [browser2, browser3]
    When user of browser2 opens a Onezone URL in a web browser
    And user of browser3 opens a Onezone URL in a web browser
