Feature: Oneprovider Group functionality
  ...
  Scenario: User fails to join group to space because of using invalid token (clicks ENTER after entering token)
    # group 'group1' defined in env.json
    Given that in browser there is a "group1" item on the groups list
    When user of browser clicks a settings icon displayed for "group1" item on the groups list
    And user of browser sees a settings dropdown menu for "group1" item on the groups list
  ...
  Scenario: User fails to join group as subgroup because of using invalid token (clicks ENTER after entering token)
    # group 'group1' defined in env.json
    Given that in browser there is a "group1" item on the groups list
    When user of browser clicks a settings icon displayed for "group1" item on the groups list
    And user of browser sees a settings dropdown menu for "group1" item on the groups list
  ...
  Scenario: User fails to join to group because of using invalid token (clicks ENTER after entering token)
  ...
  Scenario: User successfully renames group (clicks ENTER after entering group name)
    # group 'group1' defined in env.json
    Given that in browser there is a "group1" item on the groups list
    When user of browser clicks a settings icon displayed for "group1" item on the groups list
    And user of browser sees a settings dropdown menu for "group1" item on the groups list
