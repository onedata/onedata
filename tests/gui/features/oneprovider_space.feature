Feature: Oneprovider space functionality
  ...
  Background:
    ...
    Then user should see that the new item has appeared on the spaces list
  ...
  Scenario: Rename existing space and then rename it back
    ...
    And user should see a settings dropdown menu for "space1" item on the spaces list
    ...
    Then user should see that the "NewNameSpace" has appeared on the spaces list
    ...
    And user should see a settings dropdown menu for "NewNameSpace" item on the spaces list
    And user clicks on the "RENAME" item in current settings dropdown
    And user should see that "Rename a space" input box is active
  ...
  Scenario: Set given space as home and than set previous space as home
    ...
    And user should see a settings dropdown menu for "space2" item on the spaces list
  ...
  Scenario: Leave existing space and then create space with the same name
    ...
    And user presses enter on keyboard
    And user should see that the "space2" has appeared on the spaces list
