...
#    Then user of browser sees that new item has appeared on spaces list
#
...
#    When user of browser clicks on settings icon displayed for space1 item on the spaces list
...
#    And user of browser sees that modal has disappeared
#    Then user of browser sees that space1 has disappeared from spaces list
#    And user of browser sees that NewNameSpace has appeared on spaces list
#    # TODO rm code below after REST API become available
#    And user of browser clicks on settings icon displayed for NewNameSpace item on the spaces list
...
#    And user of browser sees that modal has disappeared
#    And user of browser sees that NewNameSpace has disappeared from spaces list
#    And user of browser sees that space1 has appeared on spaces list
