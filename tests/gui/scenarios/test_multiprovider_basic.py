...
pytestmark = pytest.mark.skip('There can be only 1 provider when using getting started, '
                              'so multiprovider tests are impossible in such environment')
...
# TODO rewrite scenarios to use env up set by rest
