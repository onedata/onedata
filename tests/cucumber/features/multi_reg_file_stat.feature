Feature: Multi_regular_file_stat
  ...
  Scenario: Access time
    ...
    And access time of u2's file1 becomes greater than status-change time on client2 within 15 seconds
  ...
  Scenario: Modification time
    ...
    And modification time of u2's file1 becomes greater than access time on client2 within 15 seconds
    And modification time of u2's file1 becomes equal to status-change time on client2 within 15 seconds
  ...
  Scenario: Status-change time when changing mode
    ...
    And u1 changes file1 mode to 211 on client1
    Then last operation by u1 succeeds
    And status-change time of u2's file1 becomes greater than modification time on client2 within 15 seconds
    And status-change time of u2's file1 becomes greater than access time on client2 within 15 seconds
