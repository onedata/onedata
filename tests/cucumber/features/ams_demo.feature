...
#
  ...
  Scenario: Local/Local space - create files and see them on external provider
    When u1 creates regular files [spaces/s1/file1, spaces/s1/file2, spaces/s1/file3] on client1_p1
  ...
  Scenario: Local/Local space - create empty file and read it on external provider
    When u1 creates regular files [spaces/s1/file] on client1_p1
    Then user waits 10 seconds
...
#
  ...
  Scenario: Proxy/Local space - create files and see them on external provider
    When u1 creates regular files [spaces/s1/file1, spaces/s1/file2, spaces/s1/file3] on client1_p3
    Then user waits 10 seconds
  ...
  Scenario: Proxy/Local space - create empty file and read it on external provider
    When u1 creates regular files [spaces/s1/file] on client1_p3
    Then user waits 10 seconds
