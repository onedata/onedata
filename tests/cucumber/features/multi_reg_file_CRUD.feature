Feature: Multi_regular_file_CRUD
  ...
  Scenario: Rename regular file with permission
    ...
    And u2 sees [file2] in spaces/s1/dir1 on client2
    And u1 doesn't see [file1] in dir1 on client1
    And u1 doesn't see [file1] in spaces/s1/dir1 on client1
  ...
  Scenario: Read and write to regular file
    ...
    And u2 waits up to 10 seconds # wait for events handling
  ...
  Scenario: Read regular file without read permission
    ...
    And u1 waits up to 10 seconds # wait for events handling
